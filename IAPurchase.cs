...
public class IAPurchase: MonoBehaviour, IStoreListener
{
    ...
    private string removeAllAds = "Remove_Ads_PizzaForkFiesta";
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        if (String.Equals(args.purchasedProduct.definition.id, removeAllAds, StringComparison.Ordinal))
        {
            ...
            //..Bool is now true, Processing Transaction - Remove all Ads for the User;
    ...
    public void RestorePurchases()
    {
...

        {
            ...
            //Custom method to Restore Transactions for the User;
            customerTransaction();
    ...
    public void customerTransaction()
    {
        if (m_StoreController != null)
        {
            if (m_StoreController.products.WithID(removeAllAds).hasReceipt)
            {
                ...
                {
                    //User already bought the app, Remove all Ads for them;
